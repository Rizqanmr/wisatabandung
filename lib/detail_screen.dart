...
class DetailScreen extends StatelessWidget {
  ...
  const DetailScreen({Key? key, required this.place, this.index}) : super(key: key);
...
class DetailMobilePage extends StatelessWidget {
  ...
  const DetailMobilePage({Key? key, required this.place, this.index}) : super(key: key);
...
class DetailWebPage extends StatefulWidget {
  ...
  const DetailWebPage({Key? key, required this.place, this.index}) : super(key: key);
